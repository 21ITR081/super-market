...
const CartPage = () => {
    ...
    const buyNowFunction = async () => {
        ...
        try {
            ...
            setOrderPlaced(true); // Set order placed to true after successful storage
    ...
    useEffect(() => {
        if (orderPlaced) {
            // Redirect to external URL after order is placed and data is stored
            window.location.href = "https://pages.razorpay.com/pl_Mk6KFlQswbw7xl/view";
        }
    }, [orderPlaced]);
